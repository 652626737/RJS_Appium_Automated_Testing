...
class PersonalInfo():
    ...
    def InputPersonalInfo(self):
        ...
        # 执行第三种职业身份时，启动这段代码
        p1 = resolution.abst(768, 1280, 400, 1000)
        p2 = resolution.abst(768, 1280, 400, 800)
        self.driver.swipe(p1.abst_x(),
                          p2.abst_y(),
                          p1.abst_x(),
                          p2.abst_y())
        ...
        self.driver.implicitly_wait(10)
        try:
            self.driver.find_element_by_xpath('//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.support.v7.widget.RecyclerView[1]/android.widget.RelativeLayout[3]/android.widget.ImageView[2]').click()
        ...
        self.driver.implicitly_wait(10)
        try:
            self.driver.find_element_by_xpath('//android.widget.LinearLayout[1]/android.widget.FrameLayout[1]/android.widget.RelativeLayout[1]/android.support.v7.widget.RecyclerView[1]/android.widget.RelativeLayout[4]/android.widget.ImageView[2]').click()
            self.driver.implicitly_wait(2)
            self.driver.find_element_by_id('com.rjs.ddjr:id/action_done').click()
            print('身份证反面正在上传，请稍后...')
            # sleep(6)
            ...
            p1=resolution.abst(768, 1280, 100, 500)
            p2=resolution.abst(768, 1280, 100, 100)
            self.driver.swipe(p1.abst_x(),
                              p2.abst_y(),
                              p1.abst_x(),
                              p2.abst_y())
            ...
            # 随机读取身份证号码并写入到字段中
            with open("C:\credit_number.txt", "r") as fp:
                line = fp.readlines()
                identification_number = random.choice(line)

            el.send_keys(identification_number)
            self.driver.hide_keyboard()
            print("证件号码输入完成")
            self.driver.implicitly_wait(2)
